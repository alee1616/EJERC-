...
using System.Collections.Generic; // Necesario para usar List<T> y otras colecciones genéricas
...
namespace BibliotecaEstructurada // Namespace para organizar el código y evitar conflictos de nombres.
{
    ...
    class Program // Clase principal del programa
    {
        ...
        static void Main(string[] args) // el string[] args es para recibir argumentos desde la línea de comandos
        {
           ...
           //El menú debe mostrarse al menos una vez aunque el usuario elija salir.
           //Se repite mientras la opción sea diferente de 4 (la opción de salida).
           //Es más adecuado que un while simple, porque do-while asegura que se ejecute mínimo una vez.
            {
                ...
                switch (opcion) // switch es una estructura de control que permite seleccionar 
                                ...
                                //Es más limpio y legible que varios if-else if.
                                // //Permite manejar múltiples opciones del menú de forma clara.
                                // //Facilita la ampliación futura (por ejemplo, agregar nuevas opciones como “Eliminar libro”).
                {
                    case 1:
        ...
        static void BuscarPorAutor() // el static para que sea accesible desde Main y otros métodos, el void porque no devuelve nada
        {
            ...
            //Para validar datos de entrada (que no sean vacíos o solo espacios).
            // Para verificar condiciones específicas (si hay libros o no).
            // else permite dar una alternativa clara cuando la condición no se cumple.
            {
